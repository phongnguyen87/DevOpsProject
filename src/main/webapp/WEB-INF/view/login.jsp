<%-- 
    Document   : login
    Created on : Oct 17, 2018, 1:29:00 AM
    Author     : Bill
--%>
...
<html>
	<head>
		...
		<title>Devops pages 1</title>
		<!-- Bootstrap -->
		<link rel="stylesheet" href="${pageContext.request.contextPath}/app-resources/scripts/bootstrap/bootstrap.min.css">
		<!-- IonIcons -->
		<link rel="stylesheet" href="${pageContext.request.contextPath}/app-resources/scripts/ionicons/css/ionicons.min.css">
		<!-- Toast -->
		<link rel="stylesheet" href="${pageContext.request.contextPath}/app-resources/scripts/toast/jquery.toast.min.css">
		<!-- OwlCarousel -->
		<link rel="stylesheet" href="${pageContext.request.contextPath}/app-resources/scripts/owlcarousel/dist/assets/owl.carousel.min.css">
		<link rel="stylesheet" href="${pageContext.request.contextPath}/app-resources/scripts/owlcarousel/dist/assets/owl.theme.default.min.css">
		<!-- Magnific Popup -->
		<link rel="stylesheet" href="${pageContext.request.contextPath}/app-resources/scripts/magnific-popup/dist/magnific-popup.css">
		<link rel="stylesheet" href="${pageContext.request.contextPath}/app-resources/scripts/sweetalert/dist/sweetalert.css">
		<!-- Custom style -->
		<link rel="stylesheet" href="${pageContext.request.contextPath}/app-resources/css/style.css">
		<link rel="stylesheet" href="${pageContext.request.contextPath}/app-resources/css/skins/all.css">
		<link rel="stylesheet" href="${pageContext.request.contextPath}/app-resources/css/demo.css">
	</head>
	...
	<body>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-3 col-sm-12">
							<div class="brand">
								<a href="index.html">
									<img src="${pageContext.request.contextPath}/app-resources/images/logo.png" alt="Magz Logo">
								</a>
							</div>						
						</div>
												...
												<div class="row">
													<article class="article col-md-4 mini">
														<div class="inner">
															<figure>
																<a href="single.html">
																	<img src="${pageContext.request.contextPath}/app-resources/images/news/img10.jpg" alt="Sample Article">
																</a>
															</figure>
															<div class="padding">
																<div class="detail">
													...
													<article class="article col-md-4 mini">
														<div class="inner">
															<figure>
																<a href="single.html">
																	<img src="${pageContext.request.contextPath}/app-resources/images/news/img11.jpg" alt="Sample Article">
																</a>
															</figure>
															<div class="padding">
																<div class="detail">
													...
													<article class="article col-md-4 mini">
														<div class="inner">
															<figure>
																<a href="single.html">
																	<img src="${pageContext.request.contextPath}/app-resources/images/news/img14.jpg" alt="Sample Article">
																</a>
															</figure>
															<div class="padding">
																<div class="detail">
						...
						<div class="block">
							...
							<div class="block-body">
								<figure class="foot-logo">
									<img src="${pageContext.request.contextPath}/app-resources/images/logo-light.png" class="img-responsive" alt="Logo">
								</figure>
							...
							<div class="block-body">
								<article class="article-mini">
									<div class="inner">
										<figure>
											<a href="single.html">
												<img src="${pageContext.request.contextPath}/app-resources/images/news/img12.jpg" alt="Sample Article">
											</a>
										</figure>
										<div class="padding">
								...
								<article class="article-mini">
									<div class="inner">
										<figure>
											<a href="single.html">
												<img src="${pageContext.request.contextPath}/app-resources/images/news/img15.jpg" alt="Sample Article">
											</a>
										</figure>
										<div class="padding">
								...
								<article class="article-mini">
									<div class="inner">
										<figure>
											<a href="single.html">
												<img src="${pageContext.request.contextPath}/app-resources/images/news/img16.jpg" alt="Sample Article">
											</a>
										</figure>
										<div class="padding">
		...
		<!-- JS -->
		<script src="${pageContext.request.contextPath}/app-resources/js/jquery.js"></script>
		<script src="${pageContext.request.contextPath}/app-resources/js/jquery.migrate.js"></script>
		<script src="${pageContext.request.contextPath}/app-resources/scripts/bootstrap/bootstrap.min.js"></script>
		<script>var $target_end=$(".best-of-the-week");</script>
		<script src="${pageContext.request.contextPath}/app-resources/scripts/jquery-number/jquery.number.min.js"></script>
		<script src="${pageContext.request.contextPath}/app-resources/scripts/owlcarousel/dist/owl.carousel.min.js"></script>
		<script src="${pageContext.request.contextPath}/app-resources/scripts/magnific-popup/dist/jquery.magnific-popup.min.js"></script>
		<script src="${pageContext.request.contextPath}/app-resources/scripts/easescroll/jquery.easeScroll.js"></script>
		<script src="${pageContext.request.contextPath}/app-resources/scripts/sweetalert/dist/sweetalert.min.js"></script>
		<script src="${pageContext.request.contextPath}/app-resources/scripts/toast/jquery.toast.min.js"></script>
		<script src="${pageContext.request.contextPath}/app-resources/js/demo.js"></script>
		<script src="${pageContext.request.contextPath}/app-resources/js/e-magz.js"></script>
	</body>
</html>
